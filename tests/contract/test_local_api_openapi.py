...
def test_openapi_declares_the_current_authenticated_v1_surface() -> None:
    ...
    expected_operations = (
        ...
        ("/api/v1/conversations/{conversation_id}/file-changes", "get", "200"),
        ("/api/v1/file-changes/{change_id}/undo", "post", "200"),
        ("/api/v1/runs/{run_id}", "get", "200"),
        ("/api/v1/runs/{run_id}/cancel", "post", "202"),
        ("/api/v1/runs/{run_id}/events", "get", "200"),
        ("/api/v1/tool-approvals/{approval_id}", "get", "200"),
        ("/api/v1/tool-approvals/{approval_id}/decision", "post", "200"),
    )
